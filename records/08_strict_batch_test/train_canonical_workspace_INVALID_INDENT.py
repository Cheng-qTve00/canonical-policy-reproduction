...
class TrainCanonicalWorkspace:
    ...
    def run(self):
        ...
        cprint("-----------------------------", "yellow")
        # configure logging (disabled for local reproduction)
        class DummyWandbRun:
        ...
        while self.epoch < cfg.training.num_epochs:
            ...
            with tqdm.tqdm(train_dataloader, desc=f"Training epoch {self.epoch}", 
                ...
                # Emulate official batch_size=128 with physical batch_size=32.
                # Four full micro-batches form one 128-sample update.
                # The final short batch is a separate full-weight update.
                ...
                # Keep gradient accumulation inside the current epoch.
                should_step = (
                ...
                # EMA follows actual optimizer updates.
